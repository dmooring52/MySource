...
namespace SingingClubSync
{
    public class Utility
    {
        ...
        public static string QuotedSQLString(string cmd)
        {
            return "'" + SqlString(cmd) + "'";
        }
        public static string QuotedSQLDate(DateTime dt)
        {
            return "'" + SqlDate(dt) + "'";
        }
        public static string SqlDate(DateTime dt)
        {
            return string.Format("{0}/{1}/{2} {3}:{4}:{5}", dt.Year, d2(dt.Month), d2(dt.Day), d2(dt.Hour), d2(dt.Minute), d2(dt.Second));
        }
        public static string d2(int d)
        {
            if (d <= 0)
                return "00";
            else if (d < 10)
        ...
        public static string NumberOrZero(string cmd)
        {
            int num = 0;
            if (int.TryParse(cmd, out num) == true)
                return num.ToString();
            else
                return "0";
        }
