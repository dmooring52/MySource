namespace SingerQueuer
{
    partial class QueuerForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.queueControl1 = new SingerQueuer.QueueControl();
			this.tabRound2 = new System.Windows.Forms.TabPage();
			this.queueControl2 = new SingerQueuer.QueueControl();
			this.tabRound3 = new System.Windows.Forms.TabPage();
			this.queueControl3 = new SingerQueuer.QueueControl();
			this.tabRound4 = new System.Windows.Forms.TabPage();
			this.queueControl4 = new SingerQueuer.QueueControl();
			this.tabRound5 = new System.Windows.Forms.TabPage();
			this.queueControl5 = new SingerQueuer.QueueControl();
			this.tabRound6 = new System.Windows.Forms.TabPage();
			this.queueControl6 = new SingerQueuer.QueueControl();
			this.tabSingers = new System.Windows.Forms.TabPage();
			this.singersControl1 = new SingerQueuer.SingersControl();
			this.tabEvents = new System.Windows.Forms.TabPage();
			this.eventsControl1 = new SingerQueuer.EventsControl();
			this.tabVenues = new System.Windows.Forms.TabPage();
			this.venuesControl1 = new SingerQueuer.VenuesControl();
