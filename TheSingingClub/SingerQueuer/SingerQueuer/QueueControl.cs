...
namespace SingerQueuer
{
	public partial class QueueControl : UserControl
	{
		...
		public void SetSingers()
		{
			...
			cbc.Items.Clear();
			string singersXml = _queuerForm.controlTag.singersXml;
			try
			{
				if (singersXml != null && singersXml.Trim().Length > 0)
				{
					XmlDocument doc = new XmlDocument();
					doc.LoadXml(singersXml);
		...
		private void LoadTSCQueue(string xml)
		{
